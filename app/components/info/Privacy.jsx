      ...
      <Base>
        <Paper style={paperStyle} zDepth={5}>
          ...
          <div>
            ...
            <br />
            <div>When registering on our site, as appropriate, you may be asked to enter your name, email address or other details to help you with your experience.</div>
            <br />
            <div>
              <strong>When do we collect information?</strong>
            </div>
            <br />
            <div>We collect information from you when you register on our site or enter information on our site.</div>
            <br />
            <div>
            ...
            <br />
            <ul>
              <li>To personalize user's experience and to allow us to deliver the type of content in which you are most interested.</li>
            </ul>
            <br />
            <div>
            ...
            <br />
            <div>Our website is scanned on a regular basis for security holes and known vulnerabilities in order to make your visit to our site as safe as possible.
              <br />
              <br />
            </div>
            ...
            <div>We do not use an SSL certificate.
              We only provide articles and information, we never ask for personal or private information like email addresses, or credit card numbers.</div>
            <br />
            <div>
              <strong>Do we use 'cookies'?</strong>
            </div>
            <br />
            <div>We do not use cookies for tracking purposes
            </div>
            <div>
            ...
            <div>
              <strong><br />If at any time you would like to unsubscribe from receiving future emails, you can email us </strong>
          ...
          <div>www.plaaant.com</div>
          <div>wildfiction@gmail.com</div>
          <div>
            <br />Last Edited on 2016-01-24</div>
        </Paper>
      </Base>
    );
  }
