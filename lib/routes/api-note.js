...
export default (app) => {
  ...
  */
  ...
  function imageNote(req, res, next) {
    ...
    // note: { one: 'test one', two: 'test two' }
    // req.files': [ {
    // fieldname: 'file',
    ...
    // size: 6386317,
    // bucket: 'i.plaaant.com/up/orig',
    // key: '2069b03b-75c6-4d41-964d-e19e6ddbd416.jpg',
    // acl: 'public-read',
    // contentType: 'image/jpeg',
    // metadata: { userId: '57c74b40a901d8113f7db602', ... },
    // location: 'https://s3.amazonaws.com/i.plaaant.com/up%2Forig%2F2069b03b-75c6-4d41-964d-e19e6ddbd416.jpg',
