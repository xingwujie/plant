...
module.exports = (app) => {
  ...
  app.post('/api/note', requireToken, (req, res) => {
    ...
    req.body.date = parseInt(req.body.date, 10);

    validateNote(req.body, (validateNoteError, transformed) => {
      ...
      mongo.upsertNote(transformed, (upsertNoteError, result) => {
        if(upsertNoteError) {
  ...
  app.post('/api/notes', (req, res) => {
    ...
    if(plantId) {
      mongo.getNotesByPlantId(plantId, (getNotesByPlantIdErr, notes) => {
