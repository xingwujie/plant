    ...
    super.getDb((err, db) => {
      ...
      db.view('plants', 'plants-by-user', params, (err2, body) => {
        ...
        if(body.rows.length > 0) {
          // TODO: Is this covered by a test?
          //       Should be able to swap out _.pluck for map:
          // _.map(body.row 'value')
          // _.pluck will be deprecated.
          const result = _.pluck(body.rows, 'value');
