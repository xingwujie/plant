...
export class BaseDB {
  constructor() {
    this.cloudant = Cloudant({
      account: process.env.PLANT_DB_ACCOUNT || secrets.cloudant.account,
      password: process.env.PLANT_DB_PASSWORD || secrets.cloudant.password
    });
  }
  ...
  getDb(cb) {
    ...
    this.cloudant.db.list((err, allDbs) => {
      ...
      const dbName = process.env.PLANT_DB_NAME || secrets.cloudant.dbName;
